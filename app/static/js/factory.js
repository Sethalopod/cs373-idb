...
mainApp.factory('ToolFetchFactory', function() {
  var objectCache = [
    { id: 0, name: 'AngularJS',   link: 'https://angularjs.org/'},
    { id: 1, name: 'BootstrapJS', link: 'http://getbootstrap.com/'},
    { id: 2, name: 'Flask',       link: 'http://flask.pocoo.org/'},
    { id: 3, name: 'Apiary',      link: 'https://apiary.io/'},
    { id: 4, name: 'SQLAlchemy',  link: 'http://www.sqlalchemy.org/'},
    { id: 5, name: 'yUML',        link: 'http://yuml.me/'}
    ];
    return {
      fetch: function () {
        return objectCache;
...
mainApp.factory('DataUsedFetchFactory', function() {
  var objectCache = [
    { id: 0, name: 'FoodFacts',            link: 'https://api.foodfacts.com/'},
    { id: 1, name: 'Spoonacular',          link: 'https://market.mashape.com/spoonacular/recipe-food-nutrition'},
    { id: 2, name: 'Github Issue Tracker', link: 'https://github.com/Sethalopod/cs373-idb/issues'},
    { id: 3, name: 'Repository',           link: 'https://github.com/Sethalopod/cs373-idb'},
    { id: 4, name: 'Wiki',                 link: 'https://github.com/Sethalopod/cs373-idb/wiki'}
    ];
    return {
      fetch: function () {
        return objectCache;
